...
import com.lzh.annotation.Log;
import com.lzh.annotation.ParamXssPass;
import com.lzh.annotation.ValidationParam;
import com.lzh.aspect.*;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(* com.lzh.controller..*(..))  ")
    public void aspect() {
    }
    ...
    public Object validationPoint(ProceedingJoinPoint pjp)throws Throwable{
        ...
        //是否需要验证参数
        if (!CommonUtil.isEmpty(StringUtil.getMethodAnnotationOne(method, ValidationParam.class.getSimpleName()))) {
