...
import com.lzh.entity.OperationLog;
import com.lzh.service.IOperationLogService;
import com.lzh.service.SpringContextBeanService;
    ...
    private void logHandle (ProceedingJoinPoint joinPoint ,
        ...
        for (int i = 0; i < args.length; i++) {
            if(args[i] instanceof JSONObject){
                ...
                if(!CommonUtil.isEmpty(parse.getString("password"))){
                    parse.put("password","*******");
                }
                if(!CommonUtil.isEmpty(parse.getString("rePassword"))){
                    parse.put("rePassword","*******");
                }
                if(!CommonUtil.isEmpty(parse.getString("oldPassword"))){
